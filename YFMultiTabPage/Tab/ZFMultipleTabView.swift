//
//  YFMultipleTabView.swift

protocol YFMultipleTabViewDelegate: NSObjectProtocol {
    func selectedIndexInMultipleTabView(multipleTabView: YFMultipleTabView, selectedIndex: Int)
}

import UIKit

class YFMultipleTabView: UIView {
    
    // MARK: - Public Preproty
    weak var delegate: YFMultipleTabViewDelegate?
    ...
    // tab的配置
    private var config: YFMultipleTabViewConfig!
        
    init(frame: CGRect, titles: [String], config: YFMultipleTabViewConfig, defaultIndex: Int = 0) {
